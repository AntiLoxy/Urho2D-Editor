...
namespace Geode
{
	class MoveTool : public Geode::ITool
	{
		URHO3D_OBJECT(MoveTool, Geode::ITool)

	public:
		/// Constructors.
		explicit MoveTool(Urho3D::Context* context, Geode::CommandHistory::Ptr commandHistory, Geode::SceneView::Ptr sceneView);
	...
	private:
		...
		bool editing_;
		Urho3D::Vector2 beginNodePosition_;
		Urho3D::Vector2 currentNodePosition_;
	};
}